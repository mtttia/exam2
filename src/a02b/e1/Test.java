...
public class Test {
	 ...
	 * un curriculum presentato da uno studente) sni settore o 
	 * gruppo di settori.oddisfa o meno i requisiti, espressi da una logica
	 * CDL-specifica, in termini di numero di crediti (minimi e/o massimi) per og
	 * 
